...
export class CustomerAddressFormComponent implements OnInit {
  ...
  constructor(private rootFormGroup: FormGroupDirective,private countryService: CountryService, 
    private stateService: StateService, private cityService: CityService,
   ...
   getAllCountries() {
   const res= this.countryService.getAllCountries().subscribe(c => this.countries = c);
    console.log(res);
  }
  getAllStates() {
