...
export class RegisterComponent implements OnInit {
  ...
  constructor(private savingAccTxnService:SavingAccTxnService,private fb: FormBuilder, 
    private accountTypeService: AccountTypeService, private router: Router,
     private customerService: CustomerService, private custAccountService: CustAccountService, 
     private savingAccountService: SavingAccountService, private loanAccountService: LoanAccountService) {
    this.displayCustomerInfoForm();
  ...
  displayCustomerInfoForm() {
    this.formName = "Enter Personal Details";
  ...
  onSubmitSavingAccountForm() {
    ...
    if (this.savingAccountForm.valid) {
      ...
      this.customerService.createCustomer(this.currentCustomer)
        .subscribe({
          next: (customer: { CustomerId: number; FirstName: string; LastName: string; }) => {
